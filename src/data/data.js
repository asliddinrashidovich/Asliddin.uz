export const blogData = [
    {
        ...
        paragraph: `<p class="text-[#e1e3e4]">
          ...
          <a target="_blank" href="https://www.epam.com" class="text-blue-500">EPAM</a>
           EPAM and Google Developer Expert in Flutter, Dart, Firebase, and AI, will share his practical insights on building Mobile and Web Apps with GenAI tools.
    ...
    },
    {
        ...
        paragraph: `<p class="text-[#e1e3e4]">
            ...
            tomonidan 10-11-sinf va litsey o'quvchilari uchun Matematikadan Respublika fan olimpiadasi o'tkazildi!
            G'olib va sovrindorlar  — 50, 20 va 10 mln so'mlik naqd pul mukofotlari, shuningdek, 20 televizor va 10 ta noutbuk bilan taqdirlandilar!
    ...
    },
    {
        ...
        paragraph: `<p class="text-[#e1e3e4]">
            ...
            <a target="_blank" href="https://t.me/lazyprogrammer" class="text-blue-500">Azim Pulat</a> !, 
             bo'ldi. 
            Yosh dasturchilar va bu sohaga endi qadam qo'yayotgan o'quvchilar master-klassda yangi bilimlarga ega bo'lishdi.
